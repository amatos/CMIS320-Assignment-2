...
Each AAMapper associates one mapper entry to one Actor.\\
Each Actor may associate to one or more AAMapper.\\
\\
Each AAMapper associates one mapper entry to one Award.\\
Each Award associates to only one AAMapper.\\
\\
