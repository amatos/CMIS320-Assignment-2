...
Each AAMapperID associates one mapper entry to one Actor.\\
Each Actor associates may associate to one or more AAMapperID.

Each AAMapperID associates one mapper entry to one Award.\\
Each Award associates to a single AAMapperID.

Each AMMapperID associates one mapper entry to one Actor.\\
One Actor associates to a single AMMapperID.

Each AMMapperID associates one mapper entry to one Movie.\\
Each Movie associates to a single AMMapperID.
