...
An AMMapperID associates one mapper entry to one Actor.\\
One Actor associates to a single AMMapperID.

An AMMapperID associates one mapper entry to one Award.\\
One Award associates to a single AMMapperID.
