...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\linewidth]{Data Model.png}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:AMMapper}
    \includegraphics[width=0.7\linewidth]{"AMMapper - Actors - Movies.png"}
\end{figure}
\begin{figure}[H]
    \centering
    \caption{DAMapper: Map Directors to Awards}
    \label{fig:DAMapper}
    \includegraphics[width=0.7\linewidth]{"DAMapper - Directors - Awards.png"}
\end{figure}
