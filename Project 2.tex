...
Each AwardID associates to a single AAMapperID.
...
Each MovieID associates to a single AMMapperID.

Each DAMapperID associates one
Each DMMapperID associates one mapper entry to one DirectorID.\\

Each DirectorID may associate to one or more DMMapperID.\\
Each DMMapperID

Each DMMapperID associates one mapper entry to one MovieID.\\
Each MovieID may associate to a single DMMapperID.
