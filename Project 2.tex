...
An AMMapperID associates one mapper entry to one Actor and one Award
One Actor and one award associates to a single AMMapperID
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{"AAMapper - Actors - Awards.png"}
    \caption[AAMapper, connective Actors/Actresses to Awards]{}
    \label{fig:aamapper---actors---awards}
\end{figure}
GGB
\begin{center}
