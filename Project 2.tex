...
An AMMapperID associates one mapper entry to one Actor \emph{and} one Award.

One Actor \emph{and} one award associates to a single AMMapperID.
...
\begin{figure}[h]
    \caption{AAMapper: Connecting Actors/Actresses and Awards}
    \centering
    \includegraphics[width=0.7\linewidth]{"AAMapper - Actors - Awards"}
\end{figure}

\begin{figure}[h]
    \caption{AMMapper: Connecting Hosts and Movies}
    \centering
    \includegraphics[width=0.7\linewidth]{"AMMapper - Actors - Movies"}
\end{figure}

\begin{figure}[h]
    \caption{DAMapper: Connecting Directors and Awards}
    \centering
    \includegraphics[width=0.7\linewidth]{"DAMapper - Directors - Awards"}
\end{figure}
